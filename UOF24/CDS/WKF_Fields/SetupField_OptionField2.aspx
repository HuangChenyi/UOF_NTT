...
<table width="100%" class="PopTable" cellspacing="1">
    ...
    <tr>
        ...
        <asp:Label ID="Label1" runat="server" Text="金額最小值"></asp:Label>
        </td>
        <td>
                        <telerik:RadNumericTextBox ID="rnumAmountMin" runat="server" Value="0"
                MaxValue="999999999"  MinValue="0"
                ></telerik:RadNumericTextBox>
        </td>
            <td>
        
    <asp:Label ID="Label3" runat="server" Text="金額最大值"></asp:Label>
    </td>
    <td>
                    <telerik:RadNumericTextBox ID="rnumAmountMax" runat="server" Value="0"
            MaxValue="999999999"  MinValue="0"
            ></telerik:RadNumericTextBox>
    </td>
    </tr>
